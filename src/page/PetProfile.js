  ...
  return (
    <View style={{ backgroundColor: "#fff" }}>
      <View style={styles.header}>
        <Text style={styles.backButton} onPress={handCloseShow}>
          &lt;
        </Text>
        ...
        <View style={styles.healthCondition}>
          ...
          >
            <View style={{ alignItems: "center", justifyContent: "center" }}>
              <Card.Title style={{ fontSize: 10, color: "#000", padding: 0 }}>
                Age
              </Card.Title>
              <Card.Title style={{ fontSize: 12, color: "#000", padding: 0 }}>
                2 year
              </Card.Title>
            </View>
          </Card>
          ...
          >
            <View style={{ alignItems: "center", justifyContent: "center" }}>
              <Card.Title style={{ fontSize: 10, color: "#000" }}>
                Weight
              </Card.Title>
              <Card.Title style={{ fontSize: 12, color: "#000" }}>
                4 kg
              </Card.Title>
            </View>
          </Card>
